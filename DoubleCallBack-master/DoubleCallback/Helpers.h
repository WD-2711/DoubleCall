...
inl PVOID KAlloc(ULONG Size, bool exec = false) {
	// ExAllocatePoolWithTag(NonPagedPool, Size, 'KgxD')
...
//process utils
// 附加到进程的步骤：PsLookupProcessByProcessId -> PsAcquireProcessExitSynchronization -> KeAttachProcess
// inl 代表内联函数
...
PVOID GetUserModuleBase(PEPROCESS Process, const char* ModName, ULONG* ModSize = 0, bool force64 = 0)
{
	...
	if (pPeb32 && !force64)
	{
		...
		for (PLIST_ENTRY32 pListEntry = (PLIST_ENTRY32)((PPEB_LDR_DATA32)pPeb32->Ldr)->InLoadOrderModuleList.Flink;
			...
			// PLDR_DATA_TABLE_ENTRY32 pEntry = ((LDR_DATA_TABLE_ENTRY32 *)( (PCHAR)(pListEntry) - (ULONG_PTR)(&((LDR_DATA_TABLE_ENTRY32 *)0)->InLoadOrderLinks)))
